...
int main() {
    ...
    //load ostrvo
    Model ostrvoModel("resources/objects/ostrvo/cwmdu-cairn-edit.obj");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //render ostrvo
        glm::mat4 modelOstrvo = glm::mat4(1.0f);
        modelOstrvo = glm::scale(modelOstrvo, glm::vec3(0.5f));
        ourShader.setMat4("model", modelOstrvo);
